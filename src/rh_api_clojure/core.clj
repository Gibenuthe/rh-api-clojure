(ns rh-api-clojure.core
  (:require 
    ...
    [rh-api-clojure.lib.routes :as routes])
  (:gen-class))

(defroutes app-routes
  (GET "/" [] routes/echo-route)
  (GET "/funcionarios" [] routes/get-funcionarios-route)
  (POST "/funcionarios" [] routes/add-funcionario-route)
  (GET "/departamentos" [] routes/get-departamentos-route)
  (POST "/departamentos" [] routes/add-departamento-route)
  (GET "/funcionariosfull" [] routes/get-funcionarios-full-route))
